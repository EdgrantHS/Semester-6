...
Generative AI adalah sejenis kecerdasan buatan yang memiliki kemampuan untuk menciptakan konten baru berdasarkan keinginan pengguna. Konten yang dihasilkan oleh Generative AI sendiri dapat bervariasi dari bentuk teks, gambar, audio, dan video. Beberapa contoh Generative AI yang tersedia antara lain:

1. ChatGPT, Deep Seek, Gemini untuk menghasilkan konten teks,
2. Stable Diffussion untuk menghasilkan konten gambar,
3. Speechify untuk menghasilkan konten audio, dan
4. Sora untuk menghasilkan konten video
...
\begin{itemize}
    ...
    \item \text{Blue1Brown. (n.d.). But what is a neural network? | Deep learning chapter 1 [Video]. \\ https://www.youtube.com/playlist?list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi}
